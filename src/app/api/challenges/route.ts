...
export async function POST(req: Request) {
  try {
    ...
    const challengeToSave: Challenge = {
      ...
      type: body.type || (Array.isArray(body.sport_types) && body.sport_types[0]) || 'Run',
      sport_types: Array.isArray(body.sport_types) && body.sport_types.length > 0 ? body.sport_types : [body.type || 'Run'],
