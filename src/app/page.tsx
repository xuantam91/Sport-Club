  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 space-y-5 sm:space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-[#00BCEB]/30 shadow-2xl bg-slate-900 group">
        ...
        <div className="relative z-10 p-5 sm:p-7 lg:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8">
          <div className="space-y-3.5 max-w-2xl">
            ...
            <div className="space-y-1.5">
              ...
              <div className="pt-1">
                <span className="inline-block bg-[#CCFF00] text-slate-950 font-black text-xs sm:text-base italic px-3 py-1.5 rounded-md shadow-md shadow-[#CCFF00]/25 tracking-tight sm:whitespace-nowrap truncate max-w-full">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1.5">
              <Link
                href="/activities"
                className="flex items-center space-x-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#FC4C02] to-orange-500 hover:from-orange-500 hover:to-[#FC4C02] text-white font-extrabold text-sm shadow-md shadow-[#FC4C02]/25 transition-all transform hover:-translate-y-0.5 btn-interactive"
              >
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-3.5 w-full lg:w-auto">
            {/* Card 1: Distance */}
            <div className="glass-card p-3.5 sm:p-4 rounded-2xl border border-[#CCFF00]/40 hover:border-[#CCFF00] hover:shadow-[0_0_30px_rgba(204,255,0,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-2">
                <p className="text-[11px] font-extrabold uppercase tracking-wider text-slate-400 group-hover:text-[#CCFF00] transition-colors truncate">
                  {t('hero', 'statsTotalDistance')}
                </p>
                <div className="p-2 rounded-xl bg-[#CCFF00]/15 text-[#CCFF00] border border-[#CCFF00]/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
                  <TrendingUp className="w-4 h-4" />
                </div>
              </div>
              <div className="flex items-baseline space-x-1.5 mt-2.5 relative z-10">
              ...
              <div className="mt-2.5 flex items-center justify-between pt-2 border-t border-slate-800/80 relative z-10">
                <span className="text-[10px] text-[#CCFF00] font-bold flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#CCFF00] animate-ping" />
                  ↑ Live Strava
                </span>
                <svg className="h-3.5 w-14 text-[#CCFF00]" viewBox="0 0 50 15" fill="none">
            ...
            {/* Card 2: Points */}
            <div className="glass-card p-3.5 sm:p-4 rounded-2xl border border-[#FC4C02]/40 hover:border-[#FC4C02] hover:shadow-[0_0_30px_rgba(252,76,2,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-2">
                <p className="text-[11px] font-extrabold uppercase tracking-wider text-slate-400 group-hover:text-[#FC4C02] transition-colors truncate">
                  {t('hero', 'statsTotalPoints')}
                </p>
                <div className="p-2 rounded-xl bg-[#FC4C02]/15 text-[#FC4C02] border border-[#FC4C02]/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
              ...
              <div className="mt-2.5 flex items-center justify-between pt-2 border-t border-slate-800/80 relative z-10">
                <span className="text-[10px] text-[#FC4C02] font-bold flex items-center gap-1">
                  <Flame className="w-3.5 h-3.5 text-[#FC4C02]" /> Top Score
                </span>
                <svg className="h-3.5 w-14 text-[#FC4C02]" viewBox="0 0 50 15" fill="none">
            ...
            {/* Card 3: Athletes */}
            <div className="glass-card p-3.5 sm:p-4 rounded-2xl border border-[#00BCEB]/40 hover:border-[#00BCEB] hover:shadow-[0_0_30px_rgba(0,188,235,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-2">
                <p className="text-[11px] font-extrabold uppercase tracking-wider text-slate-400 group-hover:text-[#00BCEB] transition-colors truncate">
                  {t('hero', 'statsTotalAthletes')}
                </p>
                <div className="p-2 rounded-xl bg-[#00BCEB]/15 text-[#00BCEB] border border-[#00BCEB]/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
            ...
            {/* Card 4: Workouts */}
            <div className="glass-card p-3.5 sm:p-4 rounded-2xl border border-emerald-500/40 hover:border-emerald-400 hover:shadow-[0_0_30px_rgba(52,211,153,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-2">
                <p className="text-[11px] font-extrabold uppercase tracking-wider text-slate-400 group-hover:text-emerald-400 transition-colors truncate">
                  {t('hero', 'statsTotalLogs')}
                </p>
                <div className="p-2 rounded-xl bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
