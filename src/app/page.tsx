...
export default function LeaderboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 space-y-5 sm:space-y-6">
      {/* SPORTS HERO BANNER */}
      <div className="relative overflow-hidden rounded-3xl border border-[#00BCEB]/30 shadow-2xl bg-slate-900 group">
        ...
        <div className="relative z-10 p-4 sm:p-7 lg:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5 sm:gap-6 lg:gap-8">
          <div className="space-y-3 max-w-2xl w-full">
            <div className="inline-flex items-center space-x-1.5 sm:space-x-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-[#00BCEB]/20 border border-[#00BCEB]/40 text-[#00BCEB] text-[10px] sm:text-xs font-black uppercase tracking-widest backdrop-blur-md">
              <HeartPulse className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#CCFF00] animate-pulse" />
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-snug sm:leading-relaxed max-w-xl line-clamp-2 sm:line-clamp-none">{t('hero', 'desc')}</p>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3.5 w-full lg:w-auto">
            {/* Card 1: Distance */}
            <div className="glass-card p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-[#CCFF00]/40 hover:border-[#CCFF00] hover:shadow-[0_0_30px_rgba(204,255,0,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-1 sm:gap-2">
                <p className="text-[9px] sm:text-[11px] font-extrabold uppercase tracking-tight sm:tracking-wider text-slate-400 group-hover:text-[#CCFF00] transition-colors leading-none">
                  {t('hero', 'statsTotalDistance')}
                </p>
                <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-[#CCFF00]/15 text-[#CCFF00] border border-[#CCFF00]/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
                  <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4" />
                </div>
              </div>
              <div className="flex items-baseline space-x-1 sm:space-x-1.5 mt-1.5 sm:mt-2.5 relative z-10">
                <p className="text-lg sm:text-3xl font-black text-white group-hover:text-[#CCFF00] transition-colors drop-shadow-sm">
                  <AnimatedCounter value={totalStats.km} />
                </p>
                <span className="text-[10px] sm:text-xs font-bold text-slate-400 group-hover:text-slate-200">km</span>
              </div>
              <div className="mt-1.5 sm:mt-2.5 flex items-center justify-between pt-1.5 sm:pt-2 border-t border-slate-800/80 relative z-10">
                <span className="text-[8px] sm:text-[10px] text-[#CCFF00] font-bold flex items-center gap-0.5 sm:gap-1">
                  <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-[#CCFF00] animate-ping" />
                  ↑ Strava
                </span>
                <svg className="h-3 w-10 sm:h-3.5 sm:w-14 text-[#CCFF00]" viewBox="0 0 50 15" fill="none">
            ...
            {/* Card 2: Points */}
            <div className="glass-card p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-[#FC4C02]/40 hover:border-[#FC4C02] hover:shadow-[0_0_30px_rgba(252,76,2,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-1 sm:gap-2">
                <p className="text-[9px] sm:text-[11px] font-extrabold uppercase tracking-tight sm:tracking-wider text-slate-400 group-hover:text-[#FC4C02] transition-colors leading-none">
                  {t('hero', 'statsTotalPoints')}
                </p>
                <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-[#FC4C02]/15 text-[#FC4C02] border border-[#FC4C02]/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
                  <Zap className="w-3 h-3 sm:w-4 sm:h-4 fill-[#FC4C02]" />
                </div>
              </div>
              <div className="flex items-baseline space-x-1 sm:space-x-1.5 mt-1.5 sm:mt-2.5 relative z-10">
                <p className="text-lg sm:text-3xl font-black text-white group-hover:text-[#FC4C02] transition-colors drop-shadow-sm">
                  <AnimatedCounter value={totalStats.points} />
                </p>
                <span className="text-[10px] sm:text-xs font-bold text-slate-400 group-hover:text-slate-200">pts</span>
              </div>
              <div className="mt-1.5 sm:mt-2.5 flex items-center justify-between pt-1.5 sm:pt-2 border-t border-slate-800/80 relative z-10">
                <span className="text-[8px] sm:text-[10px] text-[#FC4C02] font-bold flex items-center gap-0.5 sm:gap-1">
                  <Flame className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-[#FC4C02]" /> Top Score
                </span>
                <svg className="h-3 w-10 sm:h-3.5 sm:w-14 text-[#FC4C02]" viewBox="0 0 50 15" fill="none">
            ...
            {/* Card 3: Athletes */}
            <div className="glass-card p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-[#00BCEB]/40 hover:border-[#00BCEB] hover:shadow-[0_0_30px_rgba(0,188,235,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-1 sm:gap-2">
                <p className="text-[9px] sm:text-[11px] font-extrabold uppercase tracking-tight sm:tracking-wider text-slate-400 group-hover:text-[#00BCEB] transition-colors leading-none">
                  {t('hero', 'statsTotalAthletes')}
                </p>
                <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-[#00BCEB]/15 text-[#00BCEB] border border-[#00BCEB]/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
                  <Users className="w-3 h-3 sm:w-4 sm:h-4" />
                </div>
              </div>
              <div className="flex items-baseline space-x-1 sm:space-x-1.5 mt-1.5 sm:mt-2.5 relative z-10">
                <p className="text-lg sm:text-3xl font-black text-white group-hover:text-[#00BCEB] transition-colors drop-shadow-sm">
                  <AnimatedCounter value={totalStats.athletes} />
                </p>
                <span className="text-[10px] sm:text-xs font-bold text-slate-400 group-hover:text-slate-200">VĐV</span>
              </div>
              <div className="mt-1.5 sm:mt-2.5 flex items-center justify-between pt-1.5 sm:pt-2 border-t border-slate-800/80 relative z-10">
                <span className="text-[8px] sm:text-[10px] text-[#00BCEB] font-bold">100% Active</span>
                <div className="flex items-end gap-0.5 sm:gap-1 h-3 sm:h-3.5">
                  <span className="w-1 sm:w-1.5 h-1.5 sm:h-2 bg-[#00BCEB] rounded-sm animate-pulse"></span>
                  <span className="w-1 sm:w-1.5 h-2.5 sm:h-3 bg-[#00BCEB] rounded-sm"></span>
                  <span className="w-1 sm:w-1.5 h-2 sm:h-2.5 bg-[#00BCEB] rounded-sm"></span>
                  <span className="w-1 sm:w-1.5 h-3 sm:h-3.5 bg-[#CCFF00] rounded-sm"></span>
                </div>
              </div>
            </div>

            {/* Card 4: Workouts */}
            <div className="glass-card p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-emerald-500/40 hover:border-emerald-400 hover:shadow-[0_0_30px_rgba(52,211,153,0.45)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] group relative overflow-hidden bg-slate-900/90 backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between relative z-10 gap-1 sm:gap-2">
                <p className="text-[9px] sm:text-[11px] font-extrabold uppercase tracking-tight sm:tracking-wider text-slate-400 group-hover:text-emerald-400 transition-colors leading-none">
                  {t('hero', 'statsTotalLogs')}
                </p>
                <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 shadow-inner group-hover:scale-110 transition-transform shrink-0">
                  <Flame className="w-3 h-3 sm:w-4 sm:h-4" />
                </div>
              </div>
              <div className="flex items-baseline space-x-1 sm:space-x-1.5 mt-1.5 sm:mt-2.5 relative z-10">
                <p className="text-lg sm:text-3xl font-black text-white group-hover:text-emerald-400 transition-colors drop-shadow-sm">
                  <AnimatedCounter value={totalStats.activitiesCount} />
                </p>
                <span className="text-[10px] sm:text-xs font-bold text-slate-400 group-hover:text-slate-200">log</span>
              </div>
              <div className="mt-1.5 sm:mt-2.5 flex items-center justify-between pt-1.5 sm:pt-2 border-t border-slate-800/80 relative z-10">
                <span className="text-[8px] sm:text-[10px] text-emerald-400 font-bold">Auto Sync</span>
                <div className="flex items-end gap-0.5 sm:gap-1 h-3 sm:h-3.5">
                  <span className="w-1 sm:w-1.5 h-1 sm:h-1.5 bg-emerald-500 rounded-sm"></span>
                  <span className="w-1 sm:w-1.5 h-2 sm:h-2.5 bg-emerald-500 rounded-sm"></span>
                  <span className="w-1 sm:w-1.5 h-3 sm:h-3.5 bg-emerald-400 rounded-sm animate-pulse"></span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Control Toolbar */}
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 glass-panel p-3 sm:p-3.5 rounded-2xl border border-slate-800">
        <div className="flex items-center p-1 bg-slate-900 rounded-xl border border-slate-800">
          <button
            onClick={() => setViewMode('individual')}
            className={`flex items-center space-x-2 px-3.5 py-1.5 rounded-lg text-xs font-bold btn-interactive ${
              viewMode === 'individual'
      ...
      {viewMode === 'individual' ? (
        top3Individual.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 lg:gap-5 pt-2">
            {/* HẠNG 2 - SILVER */}
            {top3Individual[1] && (
              <div
                onMouseEnter={(e) => triggerRankConfetti(2, e)}
                className="order-2 md:order-1 silver-podium p-4.5 sm:p-5 rounded-2xl flex flex-col items-center justify-between text-center relative overflow-hidden group hover:scale-[1.02] hover:shadow-[0_0_35px_rgba(226,232,240,0.35)] transition-all cursor-pointer"
              >
                <div className="absolute top-3 left-3 bg-slate-300 text-slate-900 font-extrabold text-[11px] px-2.5 py-0.5 rounded-full flex items-center gap-1 shadow-md">
                ...
                <div className="relative my-3">
                  <img
                    ...
                    className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-4 border-slate-300 shadow-xl group-hover:border-[#00BCEB] transition-colors"
                  />
                  <div className="absolute -bottom-1.5 -right-1 bg-slate-200 text-slate-900 w-6 h-6 rounded-full flex items-center justify-center font-black text-xs border border-white">
                    2
                  </div>
                </div>
                ...
                <div className="w-full mt-3 pt-2.5 border-t border-slate-700/50 flex justify-around text-xs">
                  <div>
                    <p className="text-slate-400 text-[10px]">{t('podium', 'totalPoints')}</p>
                    <p className="font-extrabold text-base text-[#CCFF00]">{top3Individual[1].total_points}</p>
                  </div>
                  <div>
                    <p className="text-slate-400 text-[10px]">{t('podium', 'distance')}</p>
            ...
            {top3Individual[0] && (
              <div
                ...
                className="order-1 md:order-2 gold-podium p-5 sm:p-6 rounded-2xl flex flex-col items-center justify-between text-center relative overflow-hidden group hover:scale-[1.03] hover:shadow-[0_0_45px_rgba(255,215,0,0.45)] transition-all md:-mt-3 cursor-pointer"
              >
                <div className="absolute top-3 left-1/2 -translate-x-1/2 bg-amber-400 text-amber-950 font-black text-xs px-3.5 py-0.5 rounded-full flex items-center gap-1 shadow-md shadow-amber-400/20">
                ...
                <div className="relative my-3.5">
                  ...
                  <img
                    ...
                    className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-4 border-amber-300 shadow-2xl"
                  />
                  <div className="absolute -bottom-1.5 -right-1 bg-amber-400 text-amber-950 w-7 h-7 rounded-full flex items-center justify-center font-black text-xs border-2 border-amber-100 shadow-md">
                    1
                  </div>
                </div>
                <div className="space-y-0.5">
                ...
                <div className="w-full mt-3 pt-2.5 border-t border-amber-500/20 flex justify-around text-xs">
                  <div>
                    <p className="text-amber-200/70 text-[10px] font-medium">{t('podium', 'totalPoints')}</p>
                    <p className="font-extrabold text-lg text-[#CCFF00]">{top3Individual[0].total_points}</p>
                  </div>
                  <div>
                    <p className="text-amber-200/70 text-[10px] font-medium">{t('podium', 'distance')}</p>
                    <p className="font-extrabold text-xs text-white">{(top3Individual[0].total_distance / 1000).toFixed(1)} km</p>
                  </div>
                  <div>
                    <p className="text-amber-200/70 text-[10px] font-medium">{t('podium', 'elevation')}</p>
            ...
            {top3Individual[2] && (
              <div
                ...
                className="order-3 bronze-podium p-4.5 sm:p-5 rounded-2xl flex flex-col items-center justify-between text-center relative overflow-hidden group hover:scale-[1.02] hover:shadow-[0_0_35px_rgba(234,88,12,0.35)] transition-all cursor-pointer"
              >
                <div className="absolute top-3 left-3 bg-orange-600 text-white font-extrabold text-[11px] px-2.5 py-0.5 rounded-full flex items-center gap-1 shadow-md">
                ...
                <div className="relative my-3">
                  <img
                    ...
                    className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-4 border-orange-500 shadow-xl group-hover:border-[#FC4C02] transition-colors"
                  />
                  <div className="absolute -bottom-1.5 -right-1 bg-orange-500 text-white w-6 h-6 rounded-full flex items-center justify-center font-black text-xs border border-white">
                    3
                  </div>
                </div>
                <div className="space-y-0.5">
        ...
        top3Team.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 lg:gap-5 pt-2">
            {top3Team[1] && (
              <div
                onMouseEnter={(e) => triggerRankConfetti(2, e)}
                className="silver-podium p-4.5 sm:p-5 rounded-2xl flex flex-col justify-between text-center relative cursor-pointer hover:scale-[1.02] transition-transform"
              >
                <div className="text-xs font-bold text-slate-300">{t('podium', 'silverTitle')}</div>
                <h3 className="font-bold text-xl text-white mt-1.5">{top3Team[1].team.name}</h3>
                <p className="text-xs text-slate-400 mt-0.5">{top3Team[1].member_count} {t('table', 'membersCount')}</p>
                <div className="mt-3.5 pt-2.5 border-t border-slate-700/50 flex justify-between text-xs">
            ...
            {top3Team[0] && (
              <div
                onMouseEnter={(e) => triggerRankConfetti(1, e)}
                className="gold-podium p-5 sm:p-6 rounded-2xl flex flex-col justify-between text-center relative md:-mt-3 cursor-pointer hover:scale-[1.03] transition-transform"
              >
                <div className="text-xs font-black text-amber-400 tracking-wider">{t('podium', 'goldTeam')}</div>
                <h3 className="font-black text-2xl text-white mt-1.5">{top3Team[0].team.name}</h3>
                <p className="text-xs text-amber-200/80 mt-0.5">{top3Team[0].team.description}</p>
                <div className="mt-3.5 pt-2.5 border-t border-amber-500/20 flex justify-around text-xs">
                  <div><p className="text-slate-400 text-[10px]">{t('podium', 'totalPoints')}</p><p className="font-extrabold text-lg text-[#CCFF00]">{top3Team[0].total_points}</p></div>
            ...
            {top3Team[2] && (
              <div
                onMouseEnter={(e) => triggerRankConfetti(3, e)}
                className="bronze-podium p-4.5 sm:p-5 rounded-2xl flex flex-col justify-between text-center relative cursor-pointer hover:scale-[1.02] transition-transform"
              >
                <div className="text-xs font-bold text-orange-400">{t('podium', 'bronzeTitle')}</div>
                <h3 className="font-bold text-xl text-white mt-1.5">{top3Team[2].team.name}</h3>
                <p className="text-xs text-slate-400 mt-0.5">{top3Team[2].member_count} {t('table', 'membersCount')}</p>
                <div className="mt-3.5 pt-2.5 border-t border-slate-700/50 flex justify-between text-xs">
